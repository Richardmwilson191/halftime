<footer class="bg-white dark:bg-gray-800 mt-12">
    <div class="container px-6 py-4 mx-auto">
        <div class="lg:flex">
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div
                    ...
                    <div>
                        <h3 class="text-gray-700 uppercase dark:text-white">Blog
                        </h3>
                        <a href="#"
                    ...
                    <div>
                        <h3 class="text-gray-700 uppercase dark:text-white">
                            Contact</h3>
                        <span
                            class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+1
                            526 654 8965</span>
                        <span
        ...
        <div>
            <p class="text-center text-gray-800 dark:text-white">© Brand 2020 -
