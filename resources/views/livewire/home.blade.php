<div class="dark:bg-gray-800 bg-white">
        ...
        <div class="container px-6 py-12 mx-auto">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div>
                    ...
                    <h1
                        class="mt-4 text-xl font-semibold text-gray-100 dark:text-white">
                        Lowest Costs
                    </h1>
                    <p class="mt-2 text-gray-300 dark:text-gray-400">We have the lowest cost while maintaining the highest
                        quality service. We put our customers first everytime.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <h1
                        class="mt-4 text-xl font-semibold text-gray-100 dark:text-white">
                        Everything online</h1>
    
                    <p class="mt-2 text-gray-300 dark:text-gray-400">Rent a car without ever leaving the comfort of your home.
                        Have it delivered to a location of your choice.
                    </p>
                </div>
                ...
                <div>
                    <svg class="w-8 h-8" viewBox="0 0 30 30" fill="none">
                        ...
                        <defs>
                            <clipPath id="clip0">
                                <path fill="#d1d5db" d="M0 0h30v30H0z" />
                            </clipPath>
                        </defs>
                    </svg>
                    ...
                    <p class="mt-2 text-gray-300 dark:text-gray-400">Frequent maintenance and cleaning ensure that all 
                        vehicles are the best condition for every customer.
                    </p>
                </div>
            </div>
        </div>
    ...
    <x-custom.cars></x-custom.cars>

    <div>
        <iframe
        class="w-full h-72"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.385586129715!2d-77.90094758563194!3d18.466185575656024!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8eda2a58b905e8f7%3A0x1d93e702359ad787!2sWestgate%20Hills%20Blvd%2C%20Montego%20Bay!5e0!3m2!1sen!2sjm!4v1644934355183!5m2!1sen!2sjm"
